...
define("APP_MINOR", '-RC1');    				// Never modify/remove this line - it controls the update check up.
define("RELEASE_DATE", 'Friday, 4th of May 2012');    		// Release date of this version
