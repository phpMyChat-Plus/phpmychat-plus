 ...
 */
    ...
    $translation['uploaded_too_big_ini']        = 'Ошибка загрузки файла (загруженный файл превышает лимит директивы upload_max_filesize из php.ini - %s).';
    $translation['uploaded_too_big_html']       = 'Ошибка загрузки файла (загруженный файл превышает лимит директивы MAX_FILE_SIZE определенной в HTML-форме - %s).';
    ...
    $translation['file_too_big']                = 'Файл очень большой (%s).';
    $translation['no_mime']                     = 'Невозможно определить MIME-тип файла.';
    $translation['incorrect_file']              = 'Некорректный тип файла.';
    $translation['image_too_wide']              = 'Изображение очень широкое (<= %s).';
    $translation['image_too_narrow']            = 'Изображение очень узкое (>= %s).';
    $translation['image_too_high']              = 'Изображение очень высокое (<= %s).';
    $translation['image_too_short']             = 'Изображение очень короткое (>= %s).';
    $translation['ratio_too_high']              = 'Соотношение сторон очень велико (изображение очень широкое) (<= %s).';
    $translation['ratio_too_low']               = 'Соотношение сторон очень мало (изображение очень высокое) (>= %s).';
    $translation['too_many_pixels']             = 'В изображении очень много пикселей (<= %s).';
    $translation['not_enough_pixels']           = 'В изображении недостаточно пикселей (>= %s).';
