 ...
 */
    ...
    $translation['uploaded_too_big_ini']        = 'Error al cargar el archivo (el archivo cargado excede la directiva upload_max_filesize en php.ini - %s).';
    ...
    $translation['image_too_wide']              = 'La imagen es demasiado ancha (<= %s).';
    $translation['image_too_narrow']            = 'La imagen es demasiado estrecha (>= %s).';
    $translation['image_too_high']              = 'La imagen es demasiado alta (<= %s).';
