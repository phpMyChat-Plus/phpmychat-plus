 ...
 */
    ...
    $translation['uploaded_too_big_ini']        = 'Nastal problém s uploadem (nahraný soubor přesahuje nastavenou direktivu upload_max_filesize v php.ini - %s).';
    $translation['uploaded_too_big_html']       = 'Nastal problém s uploadem (nahraný soubor přesahuje nastavenou direktivu MAX_FILE_SIZE, která byla nastavená v HTML formuláři - %s).';
    ...
    $translation['file_too_big']                = 'Soubor je příliš velký (%s).';
    $translation['no_mime']                     = 'Nepodařilo se zjistit MIME typ.';
    $translation['incorrect_file']              = 'Nesprávný typ souboru.';
    $translation['image_too_wide']              = 'Obrázek je příliš široký (<= %s).';
    $translation['image_too_narrow']            = 'Obrázek je příliš úzký (>= %s).';
    $translation['image_too_high']              = 'Obrázek je příliš vysoký (<= %s).';
    $translation['image_too_short']             = 'Obrázek je příliš nízký (>= %s).';
    $translation['ratio_too_high']              = 'Poměr stran obázku je příliš velký (obrázek je moc široký) (<= %s).';
    $translation['ratio_too_low']               = 'Image ratio too low (obrázek je moc vysoký) (>= %s).';
    $translation['too_many_pixels']             = 'Obrázek má příliš mnoho pixelů (<= %s).';
    $translation['not_enough_pixels']           = 'Obrázek ma nedostatek pixelů (>= %s).';
