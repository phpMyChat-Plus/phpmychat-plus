 ...
 */
    ...
    $translation['uploaded_too_big_ini']        = 'Hiba a fájl feltöltésekor (az elküldött fájl túllépi a %s - php.ini-ben beállított upload_max_filesize értéket).';
    $translation['uploaded_too_big_html']       = 'Hiba a fájl feltöltésekor (az elküldött fájl túllépi a %s - HTML űrlapban beállított MAX_FILE_SIZE értéket).';
    ...
    $translation['file_too_big']                = 'A fájl túl nagy (%s).';
    $translation['no_mime']                     = 'Nem határozható meg a MIME típus.';
    $translation['incorrect_file']              = 'Nem megfelelő fájltípus.';
    $translation['image_too_wide']              = 'A kép túl széles (<= %s).';
    $translation['image_too_narrow']            = 'A kép túl keskeny (>= %s).';
    $translation['image_too_high']              = 'A kép túl magas (<= %s).';
    $translation['image_too_short']             = 'A kép túl alacsony (>= %s).';
    $translation['ratio_too_high']              = 'A kép aránya túl nagy (a kép túl széles) (<= %s).';
    $translation['ratio_too_low']               = 'A kép aránya túl kicsi (a kép túl magas) (>= %s).';
    $translation['too_many_pixels']             = 'A kép túl sok képpontot tartalmaz (<= %s).';
    $translation['not_enough_pixels']           = 'A kép túl kevés képpontot tartalmaz (>= %s).';
