 ...
 */
    ...
    $translation['uploaded_too_big_ini']        = 'Errore nell’upload del file (il file caricato ha una dimensione maggiore della direttiva upload_max_filesize in php.ini - %s).';
    ...
    $translation['image_too_wide']              = 'Immagine troppo larga (<= %s).';
    $translation['image_too_narrow']            = 'Immagine troppo stretta (>= %s).';
    $translation['image_too_high']              = 'Immagine troppo alta (<= %s).';
    $translation['image_too_short']             = 'Immagine troppo bassa (>= %s).';
    $translation['ratio_too_high']              = 'Proporzioni dell’immagine troppo elevate (immagine troppo larga) (<= %s).';
    $translation['ratio_too_low']               = 'Proporzioni dell’immagine piccole (immagine troppo alta (>= %s)).';
    $translation['too_many_pixels']             = 'L’immagine ha troppi pixel (<= %s).';
    $translation['not_enough_pixels']           = 'L’immagine ha troppo pochi pixel (>= %s).';
