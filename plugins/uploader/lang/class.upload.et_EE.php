 ...
 */
    ...
    $translation['uploaded_too_big_ini']        = 'Üleslaadimise viga (laetav fail ületab «upload_max_filesize» maksimaalse suuruse «php.ini» failis - %s).';
    $translation['uploaded_too_big_html']       = 'Üleslaadimise viga (laetav fail ületab määratud «MAX_FILE_SIZE» maksimaalse suuruse HTML formis - %s).';
    ...
    $translation['image_too_high']              = 'Pilt liiga kõrge (<= %s).';
    $translation['image_too_short']             = 'Pilt liiga lühike (>= %s).';
    $translation['ratio_too_high']              = 'Pildi koefitsent liiga kõrge (pilt liiga lai) (<= %s).';
    $translation['ratio_too_low']               = 'Pildi koefitsent liiga madal (pilt liiga kõrge) (>= %s).';
