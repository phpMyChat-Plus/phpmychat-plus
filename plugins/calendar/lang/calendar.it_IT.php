...
define("L_DATE_BEFORE", "Scegliere una data prima %s");
define("L_DATE_AFTER", "Scegliere una data dopo il %s");
define("L_DATE_BETWEEN", "Scegliere una data tra\\n%s e %s");
