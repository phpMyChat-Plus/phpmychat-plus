...
BODY
{
	...
	margin: 5px;
	text-indent: 0;
	scrollbar-3dlight-color: <?php echo($COLOR_TB); ?>;
	scrollbar-arrow-color: #ffffff;
	scrollbar-base-color: <?php echo($COLOR_BK); ?>;
	scrollbar-track-color: <?php echo($COLOR_SCROLL_TRACK); ?>;
	scrollbar-darkshadow-color: <?php echo($COLOR_TB); ?>;
	scrollbar-face-color: <?php echo($COLOR_BK); ?>;
	scrollbar-highlight-color: <?php echo($COLOR_TB); ?>;
	scrollbar-shadow-color: <?php echo($COLOR_TB); ?>;
}
