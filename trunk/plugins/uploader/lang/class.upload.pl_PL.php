 ...
 */
    ...
    $translation['uploaded_too_big_ini']        = 'Błąd przy wgrywaniu pliku (rozmiar pliku przekracza ustawienia dyrektywy upload_max_filesize w php.ini - %s).';
    $translation['uploaded_too_big_html']       = 'Błąd przy wgrywaniu pliku (rozmiar pliku przekracza wartość pola MAX_FILE_SIZE ustawionego w formularzu HTML - %s).';
    ...
    $translation['file_too_big']                = 'Plik za duży (%s).';
    ...
    $translation['image_too_narrow']            = 'Obraz za wąski (>= %s).';
    $translation['image_too_high']              = 'Obraz za wysoki (<= %s).';
    $translation['image_too_short']             = 'Obraz za krótki (>= %s).';
    $translation['ratio_too_high']              = 'Ratio obrazu zbyt duże (obraz jest za szeroki) (<= %s).';
    $translation['ratio_too_low']               = 'Ratio obrazu zbyt małe (obraz jest za wysoki) (>= %s).';
    $translation['too_many_pixels']             = 'Obraz ma za dużo pikseli (<= %s).';
    $translation['not_enough_pixels']           = 'Obraz ma za mało pikseli (>= %s).';
