 ...
 */
    ...
    $translation['uploaded_too_big_ini']        = 'File upload error (the uploaded file exceeds %s - the upload_max_filesize server directive set in php.ini).';
    ...
    $translation['image_too_wide']              = 'Image too wide (<= %s).';
    $translation['image_too_narrow']            = 'Image too narrow (>= %s).';
    $translation['image_too_high']              = 'Image too high (<= %s).';
    $translation['image_too_short']             = 'Image too short (>= %s).';
    $translation['ratio_too_high']              = 'Image ratio too high (image too wide) (<= %s).';
    $translation['ratio_too_low']               = 'Image ratio too low (image too high) (>= %s).';
    $translation['too_many_pixels']             = 'Image has too many pixels (<= %s).';
    $translation['not_enough_pixels']           = 'Image has not enough pixels (>= %s).';
