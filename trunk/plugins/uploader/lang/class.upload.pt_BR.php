 ...
 */
    ...
    $translation['uploaded_too_big_ini']        = 'Erro ao carregar o arquivo (o arquivo carregado excede a directiva upload_max_filesize em php.ini - %s).';
    $translation['uploaded_too_big_html']       = 'Erro ao carregar o arquivo (o arquivo carregado excede a directiva MAX_FILE_SIZE especificado no formulario html - %s).';
    ...
    $translation['image_too_short']             = 'A imagem é muito curto (>= %s).';
    $translation['ratio_too_high']              = 'O ratio é muito alto (Imagem muito larga) (<= %s).';
    $translation['ratio_too_low']               = 'O ratio é muito baixo (Imagem muito alta) (>= %s).';
