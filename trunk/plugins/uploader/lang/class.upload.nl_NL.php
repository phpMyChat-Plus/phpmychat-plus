 ...
 */
    ...
    $translation['uploaded_too_big_ini']        = 'Upload fout (de grootte van het bestand is meer dan is toegestaan door de upload_max_filesize parameter in php.ini - %s).';
    ...
    $translation['incorrect_file']              = 'Incorrecte bestandssoort.';
    $translation['image_too_wide']              = 'De afbeelding is te breed (<= %s).';
    $translation['image_too_narrow']            = 'De afbeelding is te smal (>= %s).';
    $translation['image_too_high']              = 'De afbeelding is te hoog (<= %s).';
    $translation['image_too_short']             = 'De afbeelding is te kort (>= %s).';
    $translation['ratio_too_high']              = 'De afbeeldings ratio is te groot (de afbeelding is te breed) (<= %s).';
    $translation['ratio_too_low']               = 'De afbeeldings ratio te laag (de afbeelding is te hoog) (>= %s).';
    $translation['too_many_pixels']             = 'De afbeelding bevat te veel pixels (<= %s).';
    $translation['not_enough_pixels']           = 'De afbeelding bevat te weinig pixels (>= %s).';
    ...
    $translation['gd_missing']                  = 'GD lijkt niet geinstalleerd.';
    $translation['watermark_no_create_support'] = 'Het maken van een afbeelding uit %s wordt niet ondersteund, kan het watermerk niet lezen.';
    $translation['watermark_create_error']      = 'Kan geen %s als bron lezen, kan het watermerk niet maken.';
    $translation['watermark_invalid']           = 'Onbekend afbeelding formaat, kan het watermerk niet lezen.';
