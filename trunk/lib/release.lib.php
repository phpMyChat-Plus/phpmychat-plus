...
define("APP_MINOR", '-ß5');    				// Never modify/remove this line - it controls the update check up.
define("RELEASE_DATE", 'Friday, 2nd of June 2010');    		// Release date of this version
