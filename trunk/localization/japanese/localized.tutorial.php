...
<?php if (C_NO_SWEAR) echo("いわゆる「禁止ワード」も使えません。"); ?>
	...
	<LI>最後に、自分のメールアドレスを他人に表示しても構わない場合は、「E-mailを公開する」をチェックします。公開したくなければ、チェックしないでください。
...
<P>
<I>例：</I>Jackが「/mr はテレビを見ています」と発言すると、メッセージフレームには「<B>* Jack<?php echo(L_HELP_MR); ?></B>はテレビを見ています」と表示されます。
<br /><P ALIGN="right"><A HREF="#top">トップに戻る</A></P>
<P>
<hr />
