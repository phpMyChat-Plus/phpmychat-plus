...
define("A_SEARCH_26", "Пользователь решил скрыть эту информацию в общественных профилей, для его личной жизни. Не раскрывает это!");
define("A_SEARCH_27", "Текущий месяц");
define("A_SEARCH_28", "Все дни рождения");
