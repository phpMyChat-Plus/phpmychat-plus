...
define("L_P4_HINT2", "你準備好登陸管理面板和改變你phpMyChat 服務器的設置。也有一些其他選項，幫助您管理聊天室，用戶，信息和其它更多的。利用現有的設定連結，以便隨時訪問管理面板。");
...
define("L_P2_FORM01", "資料庫-主機 用於 phpMyChat");
...
define("L_P2_FORM12", "重命名你的管理員日誌記錄檔文件夾");
define("L_P2_FORM13", "如果您打算使用集成模塊 phpMyChat PHPNuke的或PHPBB，組態配置表必須調用 \"c_config\" 跟註冊用戶表必須調用 \"c_reg_users\"！");
...
define("L_P4_FORM2", "可選，你還可以安裝一個(機器人，虛擬用戶)到您的聊天室，因此它可以增加一些樂趣在你的聊天室。可以做到這一點，但是這是最佳時間來做這件事。 如果你點擊下面的鏈接，請不要阻止腳本在新的彈出窗口中運行！");
define("L_P4_FORM3", "安裝機器人");
?>