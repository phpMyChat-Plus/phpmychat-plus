...
define("L_MATH", "%s has posted an %s"); // e.g. "username has posted an equation" (defined above); the word "equation" will render as a url to show popup with the posted formulas
?>