...
define("L_HELP_CMD_24", "Ez a parancs megváltoztatja a jelenlegi szoba témáját. Próbáld meg figyelembe venni a többi felhasználó témáját is. Jelölj meg fontos témákat!<br />Alapbeállítás esetén, ez moderátori/admin parancs.<br />Ha a \"/topic reset\" parancsot használod, az éppen használt téma törlődik, és visszaáll a szoba alapértelmezett témájára.<br />Bizonyos esetekben a \"/topic * {}\" és \"/topic * reset\" pontosan ugyanazt csinálják, de az összes szobában (global topic és global topic reset).");
...
define("L_HELP_CMD_30", "A második parancs ugyanazt csinálja, mint a /me de mutatni fogja a te saját nemedet<br />Például * ".sprintf(L_HELP_MR, "Carlos")." TV-t néz vagy ".sprintf(L_HELP_MS, "Dolly")." boldog.");
...
define("L_CAL_FORMAT", "%Y. %B %d."); // Calendar format
