...
define("A_SHEET3_5", "Не сте направили селекция. Моля изберете поне една стая от долния списък.");
...
define("A_SEARCH_26", "Потребителят е избрал да се скрие тази информация в публични профили, за личния му живот. Не я разкрие!");
define("A_SEARCH_27", "Показване на текущия месец");
define("A_SEARCH_28", "Показване на всички рождени дни");
