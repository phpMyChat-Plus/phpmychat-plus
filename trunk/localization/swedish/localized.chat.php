...
define("L_HELP_CMD_22", "Sänder en ljudeffekt och valfritt visar ett meddelande i nuvarande rum.<br />- Användande:<br />- tidigare användningssätt: \"/buzz\" eller \"/buzz följt av det meddelande du vill skriva ut tillsammans med ljudeffekten \" - spelar standard ljud för ljudeffekt definierade i Administrations panel;<br />- utökad användande: \"/buzz ".L_HELP_BUZZ."\" eller \"/buzz ".L_HELP_BUZZ." följt av det meddelande du vill skriva ut tillsammans med ljudeffekten \" - spelar signalnamn.wav fil från plus/sounds mappen; vänligen notera tecknet \"~\" att användas i början av ljudeffektsnamnet, vilken är namn av ljud fil, utan att behöva ha tillägget .wav (bara .wav filer tillåtna).<br />I grund installation, är detta ett moderator/administratörs kommando.");
