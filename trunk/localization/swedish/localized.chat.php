...
define("L_HELP_CMD_24", "Användande: ämne skall innehålla åtminstone 2 ord.<br />Detta kommando ändrar toptext av nuvarande rum. Prova inte att åsidosätta andra användarens toptext. Använda viktig toptext.<br />Som standard, detta är ett moderator/administration kommando.<br />Användande \"/topic top reset\" kommandot raderar nuvarande toptext och återställter till standard text för rummet.<br />Valfri, \"/topic * {}\" gör exakt detsamma men, i alla rum (globala toptext återställes).");
...
define("L_HELP_CMD_30", "Andra kommando gör detsamma som /me men den kommer att visa din/er respektives kön/genus<br />Expl. * ".L_HELP_MR." Högström tittar på TV eller * ".L_HELP_MS." Maja Missil är glad.");
