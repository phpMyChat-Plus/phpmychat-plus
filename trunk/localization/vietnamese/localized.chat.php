...
define("L_EMAIL_VAL_PENDING_Done", "Sự đăng ký của bạn đã thành công và đang được xem xét.");
define("L_EMAIL_VAL_PENDING_Done1", "Bạn có thể nhận được mật khẩu , sau khi tài khoản được phê chuẩn bởi người quản trị");
define("L_EMAIL_VAL_3", "Sự đăng ký của bạn được xem xét cho %s");
define("L_EMAIL_VAL_31", "Xin chúc mừng ! Sự đăng ký của bạn đã được xem xét và phê chuẩn!");
define("L_EMAIL_VAL_32", "Đây là dữ liệu bạn đăng ký cho %s Tại %s:");
define("L_EMAIL_VAL_4", "Bạn được đăng ký tài khoản bởi %s Tại %s:");
define("L_EMAIL_VAL_41", "Ban vừa thay đổi thông tin tài khoản quan trọng cho %s tai %s (Tài Khoản ảnh hưởng: %s).");
define("L_EMAIL_VAL_5", "Ban - %s – những chi tiet tài khoản cho %s");
define("L_EMAIL_VAL_51", "Ban - %s – Tài Khoản cập nhật chi tiết cho %s");
define("L_EMAIL_VAL_6", "Đăng ký trên %s");
...
define("L_HELP_CMD_30", "Đâylàm giống như vậy như /me nhưng có thể thấy sự tương tự của bạn, the giống như thông tin tài khoản bạn<br />Ví dụ * ".L_HELP_MR." Ciprian dang xem TV hoặc * ".L_HELP_MS." Dana thì vui vẻ.");
...
define("L_HELP_ETIQ_4", "<li>Không \"spam\" tán gẫu bởi sự đánh máy vô nghĩa.</li>
...
define("L_WHOIS_OWNER", "Chủ nhân");
define("L_WHOIS_TOPMOD", "Top Người điều hành");
define("L_WHOIS_MODER", "Người điều hành");
define("L_WHOIS_MODERS", "Mod");
define("L_WHOIS_OTHERS", "Những người sử dụng khác:");
...
define("L_DEFAULT_TOPIC_1", "Đây là một đề tài mặc định. Soạn thảo localization/_owner/owner.php để thay đổi nó!");
...
define("INFO_MODS", "Những đặc tính thêm/Mod sẵn có:");
define("INFO_BOT", "Bot có sẵn của chúng ta:");
...
define("L_REG_POPUP_NOTE", "Popup của bạn thì đã được khóa!");
define("L_PRIV_POST_MSG", "Gửi một lời nhắn!");
define("L_PRIV_MSG", "Lời nhắn riêng tư Mới nhận được!");
define("L_PRIV_MSGS", "%s những thông báo riêng tư mới nhận được!");
...
define("L_PRIV_READ", "Chọn ’".L_REG_25."’ nếu bạn không muốn tán gẫu nữa!");
...
define("L_NEXT_READ", "Đọc tiếp theo %s");
define("L_ROOM_ALL", "Tất cả các phòng");
define("L_PRIV_NO_MSGS", "Không 1 tin nhắn riêng nào được nhận");
define("L_PRIV_READ_MSG", "1 Tin nhắn riêng được nhận");
define("L_PRIV_READ_MSGS", "%s Tin nhắn riêng được nhận");
define("L_PRIV_MSGS_NEW", "Mới");
define("L_PRIV_MSGS_READ", "Đọc");
define("L_PRIV_MSG6", "Trạng thái:");
...
define("L_ENABLED", "Mở");
define("L_DISABLED", "Dong");
define("L_COLOR_HEAD_SETTINGS", "Những sự thiết đặt Hiện thời trên người phục vụ này:");
define("L_COLOR_HEAD_SETTINGSa", "Màu mặc định:");
define("L_COLOR_HEAD_SETTINGSb", "Màu mặc định:");
...
define("L_COL_HELP_P3", "<u>Những năng lượng dùng màu</u>:<br />1. Người quản trị có thể sử dụng bất kỳ màu nào.<br />Màu mặc định cho người quản trị là <SPAN style=\"color:".COLOR_CA."\">".COLOR_CA."</SPAN>.<br />2. Những MOD có thể sử dụng bất kỳ màu nào nhưng <SPAN style=\"color:".COLOR_CA."\">".COLOR_CA."</SPAN> và <SPAN style=\"color:".COLOR_CA1."\">".COLOR_CA1."</SPAN>.<br />Màu mặc định cho mod là <SPAN style=\"color:".COLOR_CM."\">".COLOR_CM."</SPAN>.<br />3. Những người sử dụng khác có thể sử dụng bất kỳ màu nào <SPAN style=\"color:".COLOR_CA."\">".COLOR_CA."</SPAN>, <SPAN style=\"color:".COLOR_CA1."\">".COLOR_CA1."</SPAN>, <SPAN style=\"color:".COLOR_CM."\">".COLOR_CM."</SPAN> và <SPAN style=\"color:".COLOR_CM1."\">".COLOR_CM1."</SPAN>.");
...
define("L_HIGHLIGHT", "Điểm sáng/Không-Điểm sáng");
define("L_HIGHLIGHT_SB", "Điểm sáng/Không-Điểm sáng người sử dụng post");
...
define("L_REG_BRB", "bro (cần được đăng ký)");
define("L_DEL_BYE", "đừng chờ đợi cho tôi");
...
define("NB_USERS_IN","thành viên ".LOGIN_LINK."tán gẫu</A> vào thời gian này.");
define("USERS_LOGIN","1 thành viên ".LOGIN_LINK."tán gẫu</A> vào thời gian này");
define("NO_USER","Không ai ".LOGIN_LINK."tán gẫu</A> vào thời gian này");
define("L_PRIV_REPLY_LOGIN", "Hãy đăng nhập nếu bạn tán gẫu hay muốn ".LOGIN_LINK."hồi âm</A> tới bất kỳ PMs mới được liệt kê ở trên");

//Language names
define("L_LANG_AR", "Tây ban nha");
define("L_LANG_BG", "Tiếng Bun-ga-ri");
define("L_LANG_BR", "Tiếng Bồ đào nha Brazil");
define("L_LANG_CZ", "Tiếng Tiệp Khắc");
define("L_LANG_DA", "Đan Mạch");
...
define("L_GHOST", "Người Giấu Mặt");
define("L_SUPER_GHOST", "Kẻ Ẩn Danh");
define("L_NO_GHOST", "Rõ Ràng");

// Sorting options by Ciprian
define("L_ASC", "Tăng lên");
define("L_DESC", "Đi xuống");
