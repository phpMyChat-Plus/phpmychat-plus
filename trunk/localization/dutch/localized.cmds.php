...
define("L_CMD_ANNOUNCE", "meedelen"); // announce (send a global announcement in all rooms)
define("L_CMD_AWAY", "afwezig"); // away (set as away from pc or back)
...
define("L_CMD_CLEAR", "verwijder"); // clear (clear the messages frame and show only the last 5 posts)
define("L_CMD_DEMOTE", "degradeer"); // demote (demote an user to the lower power level - admin->mod->user)
define("L_CMD_DICE", "stenen"); // dice (throw the dice)
define("L_CMD_HELP", "lachen"); // ?,help (open the help popup page)
define("L_CMD_HIGH", "omhoog"); // high (highlight someones posts)
define("L_CMD_IGNORE", "negeer"); // ignore (ignore an user - hide his posts and show the list of ignored people)
define("L_CMD_IMG", ""); // img (post an image in the chat)
define("L_CMD_INVITE", "uitnodiging"); // invite (send an invitation to the user to follow you in your room)
...
define("L_CMD_NOTIFY", "meldingen"); // notify (enable/disable notifications)
define("L_CMD_ORDER", "sorteer"); // order (change the posts order to first-on-top or first-on-bottom - not available in IE and FF)
