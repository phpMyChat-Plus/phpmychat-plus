...
define("L_HELP_CMD_30", "Het tweede commando doet hetzelfde als het /me commando maar zal nu ook je geslacht laten weten.<br />B.V. * ".L_HELP_MR." Ciprian is tv aan het kijken of * ".L_HELP_MS." Dana is blij.");
