...
<input type="image" src="images/tutorials/make_a_donation.gif" border="0" name="submit" alt="Support with PayPal the development of phpMyChat Plus - it's fast, free and secure! And we'll be greateful to you!" title="Support with PayPal the development of phpMyChat Plus - it's fast, free and secure! And we'll be greateful to you!">
