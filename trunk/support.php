...
if (file_exists("images/tutorials/make_a_donation.gif")) $donation = "images/tutorials/make_a_donation.gif";
...
<input type="image" src=<?php echo($donation); ?> border="0" name="submit" alt="Support with PayPal the development of phpMyChat Plus - it's fast, free and secure! And we'll be greateful to you!" title="Support with PayPal the development of phpMyChat Plus - it's fast, free and secure! And we'll be greateful to you!">
