...
CREATE TABLE ".$t_config." (
 ...
 MODS varchar(255) NOT NULL default '<br />Advanced Admin, Avatars, Smilies Popup, Color Drop Box, Private Popup,<br />Quick Menu, Logs Archive, Lurking, Color names, WorldTime',
