		...
		if ($DbLink->num_rows() != 0)
		{
			...
			else
			{
				...
				if ($rows != 0)
				{
					...
					// Send e-mail
					$send = send_email("[".APP_NAME."] ".L_PASS_9, L_SET_2, L_REG_1, L_PASS_11);
...
&copy; 2007<?php echo((date(Y)>"2007") ? "-".date(Y) : ""); ?> - by <a href="mailto:ciprianmp@yahoo.com?subject=phpMychat%20Plus%20feedback" onMouseOver="window.status='Click to email author.'; return true;" title="Click to email author" target=_blank>Ciprian Murariu</a>
</P>
</BODY>
</HTML>
<?php
