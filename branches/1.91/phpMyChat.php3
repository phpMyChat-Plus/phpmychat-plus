...
if ($S) echo("<TD><SPAN style=\"color:yellow; background-color:black;\"><b>Debug data:</b><br />Admin name: <b>".C_ADMIN_NAME."</b><br />Admin email: <b>".C_ADMIN_EMAIL."</b><br />App name: <b>".APP_NAME."</b><br />App version: <b>".APP_VERSION.APP_MINOR"</b></SPAN></TD>");
?>
</CENTER>
</BODY>
</HTML>
