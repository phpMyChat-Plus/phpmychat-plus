<?php
// File : german/localized.chat.php - plus version (27.05.2007 - rev.19)
...
define("L_ERR_USR_3", "Dieser Benutzername wird schon verwendet.<br />Bitte gib das Passwort ein oder w&auml;hle einen anderen Benutzernamen.");
...
<li>Verwenden der CAPS-LOCK-TASTE ist nicht gestattet. Br&uuml;llen k&ouml;nnt Ihr zu Hause machen.</li>
<li>Bedenken Sie, dass in userem Chat Leute aus der ganzen Welt und mit unterschiedlichen Glaubensrichtungen hier sein k&ouml;nnen. Bitte seien Sie nett und h&ouml;fflich.</li>
<li> Wir bitten Sie unpolitisch zu bleiben, Gottesl&auml;sterungen o.&auml;. und Verwenden von Schimpfw&ouml;rtern zu unterlassen.</li>
<li>Reden Sie andere User nicht mit Vornamen oder Namen an, wenn sie es nicht w&uuml;nschen. Daf&uuml;r gibt es die Nicknamen.");
...
define("L_PRIV_POPUP", "Sie k&ouml;nnen dieses Popup-Feature jederzeit de- oder reaktivieren<br />wenn Sie Ihr <a href=\"#\" onClick=\"window.parent.runCmd('profile',''); return false;\" onMouseOver=\"window.status='Change your settings.'; return true\">Profil</a> editieren (nur f&uuml;r registrierte User)");
...
define("L_COL_HELP_P1", "Sie k&ouml;nnen Ihre Standardfarbe beim Editieren Ihres Profils ausw&auml;hlen (die gleiche Farbe wie f&uuml;r Ihren Usernamen). Sie haben noch zus&auml;tzlich die M&ouml;glichkeit, jede andere Farbe f&uuml;r Ihre Mitteilungen im Chat auszuw&auml;hlen. Um wieder auf Standardfarbe zu wechseln einfach in der Farbauswahl die Farbe (Null) ausw&auml;hlen - ist ganz oben in der Auswahl.");
define("L_COL_HELP_SUB2", "Hinweise:");
define("L_COL_HELP_P2", "<u>Farbenreihe </u><br />Abh&auml;ngig von dem verwendeten Browser kann es passieren, dass einige Farben nicht dargestellt werden. Es werden nur 16 Farbnamen vom W3C HTML 4.0 standard unterst&uuml;tzt.");
...
else define("WELCOME_MSG", "Willkommen im Chat. Bitte beim Chatten folgende Regel befolgen: <I>angenehm und h&ouml;fflich zu sein</I>.");
