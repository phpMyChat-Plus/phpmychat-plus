<?php
// File : german/localized.chat.php - plus version (09.07.2007 - rev.22)
...
define("L_CHG_AV", "Klicke auf \"Ändern\" im Profil-Menü<br /> um Ihr Avatar zu speichern.");
...
define("L_PRIV_POPUP", "Sie können dieses Popup-Feature jederzeit de- oder reaktivieren<br />wenn Sie Ihr <a href=\"#\" onClick=\"window.parent.runCmd('profile',''); return false;\" onMouseOver=\"window.status='Change your settings.'; return true\">Profil</a> editieren (nur für registrierte User)");
