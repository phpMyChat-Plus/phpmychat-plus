...
<HEAD>
<TITLE>Deutsche Anleitung für<?php echo(APP_NAME." - ".APP_VERSION); ?></TITLE>
...
<P CLASS="redText">
Achtung: Netscape-Benutzer müssen ihre Sprache als Standardcodierung definieren, sonst wird jedes Nachrichtenzeichen durch '?' ersetzt.<br />
...
<A HREF="#modProfile" CLASS="topLink">Modifizieren<?php if (C_SHOW_DEL_PROF == "1") echo("/Löschen"); ?> Deines Profils</A><br />
<?php
if (C_VERSION == "2")
{
	?>
...
<P>
Wenn Du bereits registriert bist, gib einfach Deinen Usernamen und Dein Passwort ein. Dann wähle, welchen Chatraum Du betreten willst und drücke auf den Chat-Knopf.<br />
<?php
...
<P>
Wenn Du noch nicht registriert bist <?php if (C_REQUIRE_REGISTER == "0") echo("und es tun willst"); ?>, wähle bitte die Registrierungsoption. Ein kleines Popup-Fenster wird erscheinen.
<P>
<UL>
...
<?php if (C_NO_SWEAR == "1") echo(" Es dürfen keine \"verbotenen Worte\" enthalten sein."); ?>
...
<P>
<A NAME="modProfile"></A>Natürlich kannst Du als registrierter Nutzer selber jederzeit Dein Profil ändern<?php if (C_SHOW_DEL_PROF == "1") echo("/löschen"); ?>. Klicke einfach auf den <?php echo((C_SHOW_DEL_PROF == "0" ? "Link" : "Link")); ?>.<br />
...
if (C_VERSION == "2")
{
	...
	<P>
	Raumnamen dürfen keine Kommata oder Rückstriche enthalten (\).<?php if (C_NO_SWEAR == "1") echo(" Es dürfen keine \"verbotenen Worte\" enthalten sein."); ?>
	<br /><P ALIGN="right"><A HREF="#top">Zurück zum Anfang</A></P>
	<P>
	<hr />
	<?php
...
<?php if (C_NO_SWEAR == "1") echo("Beachte, daß \"verbotene Worte\" aus der Nachricht entfernt werden."); ?>
<P>
