...
define("L_WEL_2", "iar userii inactivi dupa");
...
define("L_SET_9", "Creeaza-ti camera ta");
...
define("L_REG_18", "Ai fost dat afara din camera de catre un moderator al acestui chat.");
define("L_REG_18a", "Ai fost dat afara din camera de catre un moderator al acestui chat.<br>Motivul: %s");
...
define("L_ERR_USR_20a", "Ai fost blocat din aceasta camera sau de pe chat.<br>Motivul: %s");
...
define("L_ERR_USR_25", "Numai administratorul poate folosi culoarea ".$COLORNAME."!<br>Nu incerca sa folosesti ".COLOR_CA.", ".COLOR_CA1.", ".COLOR_CM." sau ".COLOR_CM1.".<br>Acestea sunt rezervate utilizatorilor speciali!");
define("L_ERR_USR_26", "Numai administratorii sau moderatorii pot folosi culoarea ".$COLORNAME."!<br>Nu incerca sa folosesti ".COLOR_CA.", ".COLOR_CA1.", ".COLOR_CM." or ".COLOR_CM1.".<br>Acestea sunt rezervate utilizatorilor speciali!");
...
define("L_NONEXIST_USER", "%s nu este in camera curenta.");
define("L_NONREG_USER", "%s nu este inregistrat.");
define("L_NONREG_USER_IP", "IP-ul sau este: %s.");
define("L_NO_KICKED", "%s este moderator sau administrator si nu poate fi dat afara.");
define("L_KICKED", "%s a fost dat afara!");
define("L_KICKED_REASON", "%s a fost dat afara! (Motivul: %s)");
define("L_NO_BANISHED", "%s este moderator sau administrator si nu poate fi blocat.");
...
define("L_INVITE", "%s te invita sa intri cu el/ea in camera <a href=\"#\" onClick=\"window.parent.runCmd('%s','%s')\">%s</a>.");
...
define("L_HELP_CMD_9", "Expulzeaza utilizatori din chat. Aceasta comanda poate fi data numai de un moderator al camerei sau de administrator.<br>Optional, [".L_HELP_REASON."] va arata si motivul eliminarii (orice fraza).");
...
define("L_HELP_CMD_24", "Comanda schimba topicul (tema de discutii) camerei in care este folosita. Incercati sa nu suprascrieti temele altor utilizatori si sa folositi teme care merita afisate.<br>Folosind comanda \"/topic top reset\" tema curenta afisata va fi stearsa si resetata tema implicita a camerei.<br>In mod implicit, aceasta comanda poate fi folosita doar de moderatori.<br>Atentie: tema de discutii trebuie sa contina cel putin 2 cuvinte.<br>Optional, \"/topic * {}\" face aceleasi lucruri dar pentru toate camerele simultan (tema globala si resetare tema globala).");
...
if ((ALLOW_ENTRANCE_SOUND == "1" || ALLOW_ENTRANCE_SOUND == "3") && ENTRANCE_SOUND) define("L_ENTER_ROM", "%s a intrat in camera" . L_ENTER_SND);
else define("L_ENTER_ROM", "%s a intrat in camera");
...
define("L_PRO_6", "Culoarea numelui/textului");
...
define("BOT_PRIV_TIPS", "Sfat: Bot-ul este public activ in camera %s. Poti discuta numai privat cu el apasand pe numele sau <b>".C_BOT_NAME."</b>. (comanda: /wisp <b>".C_BOT_NAME."</b> Mesaj)");
...
define("L_COLOR_HEAD_SETTINGSa", "<u>Culori implicite</u>: Administrator = <b><SPAN style=\"color:".COLOR_CA."\">".COLOR_CA."</SPAN></b>, Moderatori = <b><SPAN style=\"color:".COLOR_CM."\">".COLOR_CM."</SPAN></b>, Ceilalti utilizatori = <b><SPAN style=\"color:".COLOR_CD."\">".COLOR_CD."</SPAN></b>.");
define("L_COLOR_HEAD_SETTINGSb", "<u>Culoarea implicita</u>: <b><SPAN style=\"color:".COLOR_CD."\">".COLOR_CD."</SPAN></b>.");
define("L_COL_HELP_TITLE", "Spectrul de Culori");
define("L_COL_HELP_SUB1", "Folosire:");
define("L_COL_HELP_P1", "Poti sa-ti definesti culoarea ta favorita editandu-ti profilul (aceeasi cu culoarea numelui). Vei putea totusi sa folosesti si celelalte culori. Pentru a reveni la culoarea favorita dupa ce ai folosit una oarecare din lista, va trebui sa selectezi macar o data culoarea implicita (Null) - este prima din lista de culori.");
define("L_COL_HELP_SUB2", "Sfaturi:");
define("L_COL_HELP_P2", "<u>Spectrul de Culori</u><br>In functie de capabilitatile browserului si sistemului de operare folosit, este posibil ca anumite culori din cele 140 disponibile sa nu fie afisate corect (ex. pe calculatoarele foarte vechi). Numai 16 nume de culori sunt recunoscute de browserele mai vechi, care nu suporta decat standardul W3C HTML 4.0. Aceste culori de baza (numite si web-safe) sunt:");
define("L_COL_HELP_P2a", "Daca un utilizator se plange ca nu poate vedea corect culoarea pe care ai selectat-o, inseamna ca probabil foloseste un browser foarte vechi, care nu recunoaste numele culorii tale.");
define("L_COL_HELP_SUB3", "Culori implicite in acest chat:");
define("L_COL_HELP_P3", "<u>Culori in functie de permisiunile utilizatorului</u>:<br>1. Administratorul poate folosi tot spectrul de culori.<br>Culoarea administratorului este <SPAN style=\"color:".COLOR_CA."\">".COLOR_CA."</SPAN>.<br>2. Moderatorii pot folosi orice culoare, in afara de <SPAN style=\"color:".COLOR_CA."\">".COLOR_CA."</SPAN> si <SPAN style=\"color:".COLOR_CA1."\">".COLOR_CA1."</SPAN>.<br>Culoarea moderatorilor este <SPAN style=\"color:".COLOR_CM."\">".COLOR_CM."</SPAN>.<br>3. Toti ceilalti utilizatori vor putea folosi orice alta culoare, in afara de <SPAN style=\"color:".COLOR_CA."\">".COLOR_CA."</SPAN>, <SPAN style=\"color:".COLOR_CA1."\">".COLOR_CA1."</SPAN>, <SPAN style=\"color:".COLOR_CM."\">".COLOR_CM."</SPAN> si <SPAN style=\"color:".COLOR_CM1."\">".COLOR_CM1."</SPAN>.");
define("L_COL_HELP_P3a", "Culoarea implicita este <u><SPAN style=\"color:".COLOR_CD."\">".COLOR_CD."</SPAN></u>.<br /><br /><u>Informatii tehnice</u>: Aceste culori au fost definite the administrator in admin panel.<br>Daca ceva nu e in regula sau nu va plac culorile implicite, <b>administratorul</b> este primul pe care ar trebui sa-l contactezi si nu pe ceilalti utilizatori de pe chat. :-)");
...
define("COL_ERROR_BOX_USRA", "Numai administratorul poate folosi culoarea ".COLOR_CA."!\\n\\nNu incerca sa folosesti ".COLOR_CA.", ".COLOR_CA1.", ".COLOR_CM." sau ".COLOR_CM1."\\nAcestea sunt rezervate altor useri!\\n\\nCuloarea a fost resetata la ".COLOR_CD."!\\n\\nAlege orice alta culoare!");
define("COL_ERROR_BOX_USRM", "Trebuie sa fii moderator pentru a folosi culoarea ".COLOR_CM."!\\n\\nNu incerca sa folosesti ".COLOR_CA.", ".COLOR_CA1.", ".COLOR_CM." sau ".COLOR_CM1."\\nAcestea sunt rezervate altor useri!\\n\\nCuloarea a fost resetata la ".COLOR_CD."!\\n\\nAlege orice alta culoare!");
...
if ((ALLOW_ENTRANCE_SOUND == "2" || ALLOW_ENTRANCE_SOUND == "3") && WELCOME_SOUND) define("WELCOME_MSG", "Bun venit pe chat-ul nostru! Va rugam sa nu folositi expresii nepoliticoase, <I>pentru o ambianta cat mai placuta</I>." . L_ENTER_SND);
else define("WELCOME_MSG", "Bun venit pe chat-ul nostru! Va rugam sa nu folositi expresii nepoliticoase, <I>pentru o ambianta cat mai placuta</I>.");
define("WELCOME_MSG_NOSOUND", "Bun venit pe chat-ul nostru! Va rugam sa nu folositi expresii nepoliticoase, <I>pentru o ambianta cat mai placuta</I>.");
...
define("L_RELOAD_CHAT", "Setarile serverului de chat tocmai au fost modificate. Pentru o buna functionare, trebuie sa reincarcati chat-ul (apasati tasta F5 sau Iesire si reintrati pe chat).");

// Week days for status worldtime by Ciprian
define("L_MON", "Lu"); //Luni
define("L_TUE", "Ma"); //Marti
define("L_WED", "Mi"); //Miercuri
define("L_THU", "Jo"); //Joi
define("L_FRI", "Vi"); //Vineri
define("L_SAT", "Sa"); //Sambata
define("L_SUN", "Du"); //Duminica
?>