<?php
// File : romanian/localized.chat.php - plus version (20.07.2007 - rev.24)
...
define("L_CHG_AV", "Apasă ’Schimbă’ în formularul Profil<br />pentru a-ţi salva Avatarul.");
...
define("L_PRIV_POPUP", "Poţi dezactiva/reactiva aceste popup-uri<br />editându-ţi <a href=\"#\" onClick=\"window.parent.runCmd('profile',''); return false;\" onMouseOver=\"window.status='Change your settings.'; return true\">Profilul</a> (numai dacă eşti înregistrat)");
...
define("L_TUE", "Ma"); //Marţi
define("L_WED", "Mi"); //Miercuri
define("L_THU", "Jo"); //Joi
define("L_FRI", "Vi"); //Vineri
define("L_SAT", "Sâ"); //Sâmbătă
define("L_SUN", "Du"); //Duminică
...
define("L_PASS_3", "Care a fost primul tău animal?"); // Don't change this question! Just translate it!
