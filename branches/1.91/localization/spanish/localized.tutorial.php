<?php
// File : spanish/localized.tutorial.php - plus version (10.07.2007 - rev.6)
...
<P>
Mientras esté dentro de una sala de chat puede llamar a la ventana emergente (popup) de Ayuda dándole clic en la <IMG SRC="images/helpOff.gif" WIDTH=30 HEIGHT=20 BORDER=0 ALT="Ayuda"> imagen que se encuentra justo antes de la casilla de escritura. También puede escribir los <B>comandos "/help" o "/?"</B> en la casilla de escritura.
<br />
<P ALIGN="right"><A HREF="#top">Subir</A></P>
<P>
<P>
...
<P>
<FONT SIZE="+1"><B>Volviendo a ver el último mensaje o comando que ha enviado:</B></FONT>
