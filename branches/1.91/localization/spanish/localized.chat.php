...
define("L_HELP_CMD_19", "Permite que el moderador(es) de una sala o el administrador puedan \"banish\" a un usuario de una sala por un tiempo definido por el administrador.<br>El administrador puede expulsar o desterrar a un usuario que está chateando en una sala diferente a aquella en la cual él está actualmente y usar la opción '<B>&nbsp;*&nbsp;</B>' para expulsar o desterrar para \"forever\"a un usuario de todo el chat en general.<br>Opcionalmente, [".L_HELP_REASON."] muestra la razón para la expulsión o destierro (cualquier texto deseado).");
...
define("L_HELP_ETIQ_4", "No haga &quot;spam&quot; en el chat escribiendo sonseras o letras al azar.</li><li>No use mayúsculas y minúsculas sin propósito, por ejemplo pRopoSiTo</li><li>Mantenga el uso de MAYUSCULAS al mínimo, pues su uso se considera como gritar</li><li>Tenga presente que los usuarios del chat son de diferentes lugares del mundo, así que seguramente encontrará personas con diferentes creencias. Por favor sea amable y educado con estas personas.</li><li>No insulte ni diga groserías a otros miembros del chat. Es más, trate de no usar malas palabras, groserías e insultos en absoluto.</li><li>No se dirija a otros miembros del chat por sus verdaderos nombres porque puede que no les agrade. Es mejor que use sus alias.");
...
define("L_PRIV_POPUP", "Usted puede desactivar/activar esta función en cualquier momento<br>editando su perfil (sólo usuarios registrados)");
