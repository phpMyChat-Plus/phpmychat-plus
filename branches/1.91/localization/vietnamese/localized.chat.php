<?php
// File : vietnamese/localized.chat.php - plus version (17.07.2007 - rev.23)
...
define("L_WEL_1", "Những lời nói được xóa sau:");
define("L_WEL_2", "và những thành viên không họat động sau:");
...
define("L_WHOIS_MODER", "MOD");
define("L_WHOIS_USER", "Thành viên");
define("L_WHOIS_GUEST", "Người viếng thăm");
...
define("L_CHG_AV", "Click change để thay đổi thông tin <br />để cất giữ ảnh đại diện của bạn.");
...
define("L_PRIV_POPUP", "Bạn có thể vô hiệu hóa hoặc sử dụng popup<br />được sọan thảo bởi bạn <a href=\"#\" onClick=\"window.parent.runCmd('profile',''); return false;\" onMouseOver=\"window.status='Thay đổi sự thiết lập.'; return true\">Thông tin</a> (những người duy nhất được đăngký)");
...
define("L_RELOAD_CHAT", "Nếu server có thay đổi xin làm mới hay khởi động lại trình duyệt của bạn (nhấn phím F5 hay nhấn Exit để ra khỏi).");

// Extra options by Ciprian
define("L_EXTRA_OPT", "Những tùy chọn thêm");

// Week days for status worldtime by Ciprian - translate both Mo and //Monday
define("L_MON", "Thứ2"); //Thứ hai (2)
define("L_TUE", "Thứ3"); //Thứ ba (3)
define("L_WED", "Thứ4"); //Thứ bốn (4)
define("L_THU", "Thứ5"); //Thứ năm (5)
define("L_FRI", "Thứ6"); //Thứ sáu (6)
define("L_SAT", "Thứ7"); //Thứ bảy (7)
define("L_SUN", "Chủ"); //Chủ nhật
