...
<P>
Als je in een chatroom zit, kan je de helpfunctie oproepen, door op het <IMG SRC="images/helpOff.gif" WIDTH=30 HEIGHT=20 BORDER=0 ALT="Help"> te klikken, wat zich voor het berichten venster bevindt. Je kan ook <B>"/help" of "/?" commando</B> te typen in het berichten venster.
<br /><P ALIGN="right"><A HREF="#top">Naar boven</A></P>
<P>
<P>
<!-- Avatar System Start. -->
...
<P>
<FONT SIZE="+1"><B>Je eigen profiel aanpassen :</B></FONT>
<P>
...
<P>
<FONT SIZE="+1"><B>Terug halen van de laatste commando:</B></FONT>
<P>
...
<P>
<FONT SIZE="+1"><B>Reageren op een bepaalde gebruiker:</B></FONT>
<P>
