<?php
// File : argentinian_spanish/localized.tutorial.php - plus version (10.07.2007 - rev.6)
...
<TR>
	<TD ALIGN="center"><FONT SIZE="+2" COLOR="GREEN"><B>- Tutorial en Español para <?php echo(APP_NAME." - ".APP_VERSION.APP_MINOR); ?> -</FONT><br /><I>Traducido por Matias Olivera - Buenos Aires, Argentina, &copy; 2007<?php echo((date(Y)>"2007") ? "-".date(Y) : ""); ?></I></B></TD>
</TR>
</TABLE><br /><br />
<P><A NAME="top"></P>
...
<P>
Una vez dentro de un salón de chat, podés abrir una nueva ventana con ayuda haciendo click en la <IMG SRC="images/helpOff.gif" WIDTH=30 HEIGHT=20 BORDER=0 ALT="Ayuda"> imágen que se encuentra debajo del cuadro de mensaje. También podés escribir el comando <B>"/help" o "/?" </B> en el cuadro de mensaje.
<br /><P ALIGN="right"><A HREF="#top">Volver al comienzo</A></P>
<P>
<P>
<!-- Avatar System Start. -->
