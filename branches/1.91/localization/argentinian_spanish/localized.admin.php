<?php
// File : argentinian_spanish/localized.admin.php - plus version (17.09.2006 - rev.6)
...
define("A_SHEET4_0", "No ingresaste las variables requeridas en<BR>'chat/admin/mail4admin.php' script.");
...
define("A_SHEET5_1", "- La versión de tu phpMyChat-Plus instalado es %s -<br>Hay una nueva versión disponible (%s)!<br>Si deseás visitar nuestro sitio y actualizarla o enterarte las novedades, usá el siguiente link:");
?>