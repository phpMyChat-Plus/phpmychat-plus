...
define("L_ERR_USR_22", "Este comando no está disponible para\\el navegador que estas usando (motor de IE).");
...
define("L_HELP_ETIQ_4", "No hagas &quot;spam&quot; en el chat escribiendo frases o letras sin sentido.</li><li>No alternes MayúsCuLAs y MInúScUlas en las palabras</li><li>Usa lo menos posible palabras todas en mayúsculas</li><li>Recuerda que los usuarios de nuestro chat son de todo el mundo, y, seguramente, encontrarás gente con otras creencias. Por favor se amable y correcto con ellos.</li><li>No insultes a otros usuarios. De hecho, trata de evitar el uso de palabras o frases insultantes</li><li>No llames a los otros usuarios por sus verdaderos nombres. Puede no agradarles. Usa sus nicknames.");
...
define("L_PRIV_POPUP", "Podés deshabilitar/re-habilitar esta utilidad de popup cuando quieras<br>editando tu perfil (Solo usuarios registrados)");
