<?php
// File : french/localized.tutorial.php - plus version (10.07.2007 - rev.6)
...
<HEAD>
<TITLE>Tutoriel en français pour <?php echo(APP_NAME." - ".APP_VERSION.APP_MINOR); ?></TITLE>
...
{
	?>
	&nbsp;&nbsp;&nbsp;&nbsp;<A HREF="#smilies" CLASS="topLink">Emoticons graphiques</A><br />
	<?php
};
if (C_HTML_TAGS_KEEP != "none")
{
	?>
	&nbsp;&nbsp;&nbsp;&nbsp;<A HREF="#text" CLASS="topLink">Mise en forme du texte</A><br />
	<?php
};
?>
...
&nbsp;&nbsp;&nbsp;&nbsp;<A HREF="#invite" CLASS="topLink">Suggérer à utilisateur de venir dans le salon que vous occupez</A><br />
&nbsp;&nbsp;&nbsp;&nbsp;<A HREF="#changeroom" CLASS="topLink">Changer de salon de discussion</A><br />
&nbsp;&nbsp;&nbsp;&nbsp;<A HREF="#private" CLASS="topLink">Messages privés</A><br />
&nbsp;&nbsp;&nbsp;&nbsp;<A HREF="#actions" CLASS="topLink">Actions</A><br />
&nbsp;&nbsp;&nbsp;&nbsp;<A HREF="#ignore" CLASS="topLink">Ignorer les messages d’autres utilisateurs</A><br />
...
&nbsp;&nbsp;&nbsp;&nbsp;<A HREF="#announce" CLASS="topLink">Poster une annonce générale</A><br />
&nbsp;&nbsp;&nbsp;&nbsp;<A HREF="#kick" CLASS="topLink">Ejecter un utilisateur</A><br />
<?php
if (C_BANISH != "0")
{
	?>
	&nbsp;&nbsp;&nbsp;&nbsp;<A HREF="#banish" CLASS="topLink">Bannir un utilisateur</A><br />
	<?php
};
?>
&nbsp;&nbsp;&nbsp;&nbsp;<A HREF="#promote" CLASS="topLink">Promouvoir ou Degrader un utilisateur à la fonction moderateur:</A><br />
<P>
<hr />
<hr />
...
<P>
Si vous vous êtes déjà enregistré, il vous suffit d’inscrire votre nom d’utilisateur et votre mot de passe dans les champs idoines. Sélectionnez ensuite un salon de discussion et cliquez sur le bouton ’<?php echo(L_SET_14); ?>’.<br />
<?php
...
<P>
Si vous n’êtes pas encore enregistré<?php if (!C_REQUIRE_REGISTER) echo(" et que vouliez le faire"); ?>, cliquez sur le lien correspondant à cela sur la page d’accueil. Une petite fenêtre apparaîtra.
<P>
<UL>
...
<P>
<A NAME="modProfile"></A>Bien évidemment, un utilisateur enregistré peut modifier<?php if (C_SHOW_DEL_PROF) echo("/delete"); ?> son profil en cliquant sur <?php echo((!C_SHOW_DEL_PROF ? "le lien correspondant" : "les liens correspondants")); ?> de la page d’accueil.<br />
<br /><P ALIGN="right"><A HREF="#top">Début de la page</A></P>
<P>
<hr />
...
<?php if (C_NO_SWEAR) echo("Notez que les \"gros mots\" contenus dans vos messages seront remplacés par une suite de caractères définie par l’administrateur."); ?>
<P>
...
<P>
Une fois entré dans un salon de discussion, vous pourrez obtenir de l’aide en cliquant sur l’image <IMG SRC="images/helpOff.gif" WIDTH=30 HEIGHT=20 BORDER=0 ALT="Aide"> qui est placée à gauche de la "boite à messages". Vous pourrez encore utiliser les <B>commandes "/help" ou "/?"</B> à cet effet.
<br /><P ALIGN="right"><A HREF="#top">Début de la page</A></P>
<P>
<P>
<!-- Avatar System Start. -->
...
if (C_VERSION == "2")
{
	echo(!C_REQUIRE_REGISTER ? "<P>Si vous êtes un utilisateur enregistré, vous" : "<P>Vous");
	?>
...
<P>
<FONT SIZE="+1"><B>Modifier son profil une fois entré dans un salon :</B></FONT>
<P>
...
<P>
L’opération inverse (réduire un modérateur au statut d’utilisateur) using the <B>commande demote</B>.
<P>
<I>Par exemple</I>, si Jack est le pseudo de modérateur à demote: <I>/demote Jack</I> or <I>/demote * Jack</I> (will demote him from current or all the rooms).
<br /><P ALIGN="right"><A HREF="#top">Début de la page</A></P>
<P>
