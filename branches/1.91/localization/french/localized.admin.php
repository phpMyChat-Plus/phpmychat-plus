<?php
// File : french/localized.admin.php - plus version
...
define("A_SHEET1_8", "Il n&prime;y a pas d&prime;utilisateur enregistre e part pour meme.");
...
define("A_SHEET2_4", "Jusqu&prime;a");
...
define("A_SHEET2_8", "Il n&prime;y a pas d'Utilisateur Bannis.");
...
define("A_SHEET3_4", "Il n&prime;y a pas de salon e effacer.");

// Frame for sending mails
define("A_SHEET4_0", "Vous n&prime;avez pas défini les variables nécessaires dans le<br>'chat/admin/mail4admin.php' script.");
...
define("A_SHEET4_6", "Lancer l&prime;envois");
define("A_SHEET4_7", "Tout les e-mails ont été envoyés.");
define("A_SHEET4_8", "Erreur interne durant l&prime;envois des mails.");
define("A_SHEET4_9", "Destinataire(s), subject ou message ont été oublie!");

// Frame for configuration
define("A_SHEET5_0", "- La version de phpMyChat-Plus installé est %s -\\n Il y a une nouvelle version de prete (%s)!");
define("A_SHEET5_1", "- La version de phpMyChat-Plus installé est %s -<br>Il y a une nouvelle version de prete (%s)!<br>Si vous voulez visiter le site et obtenir la nouvelle version<br>ou voir ce qu&prime;il y a de nouveau, utiliser le lien suivant:");
?>
