<?php
// File : french/localized.chat.php - plus version (09.07.2007 - rev.22)
...
define("L_REG_39", "Le salon dans le quel vous trouvez a été supprimé par l’administrateur.");
...
define("L_ERR_USR_12", "Vous etes l’administrateur, aussi vous ne pouvez pas etre supprimé.");
...
define("L_ERR_USR_25", "Seul l’administrateur peu utiliser ".$COLORNAME." la couleur!<br />n’essayez pas d’utiliser ".COLOR_CA.", ".COLOR_CAS.", ".COLOR_CM." ou ".COLOR_CMS." (ou leur codes HEX correspondant).<br />Ils sont réservè aux utilisateur avec pouvoir!");
define("L_ERR_USR_26", "Seul l’administrateur ou les moderateurspeuvent utiliser ".$COLORNAME." color!<br />n’essayez pas d’utiliser ".COLOR_CA.", ".COLOR_CAS.", ".COLOR_CM." ou ".COLOR_CMS." (ou leur codes HEX correspondant).<br />ils sont réservè aux utilisateurs avec pouvoir!");
...
define("L_HELP_CMD_18", "Invite un utilisateur a vous rejoindre dans le salon oû vous vous trouvez.");
define("L_HELP_CMD_19", "Permet aux moderateurs d’un salon ou l’administrateur de \"Banir\" un utilisateur d’un salon pour un temps defini par l’administrateur.<br />Ce dernier peut Banir un utilisateur d’un autre salon que celui dans lequel il se trouve et à utiliser * l’option\"Pour toujours\" pour un utilisateur sur la totalité du chat.");
...
<li>N’appellez pas les autres utilisateur par leur vrai Nom, il risquent de ne pas aprecier.Utilisez plut崠leur Pseudo.");
...
define("L_PRIV_POPUP", " Vous pouvez désactiver/ré-activer n’importe quand ce popup de caracteristiques<br />en editant votre <a href=\"#\" onClick=\"window.parent.runCmd('profile',''); return false;\" onMouseOver=\"window.status='Change your settings.'; return true\">Profil</a> (seulement pour les utilisateur enregistrés)");
...
define("L_COL_HELP_P3", "<u>Utilisation des Couleurs selon le grade</u>:<br />1. L’administrateur peut les utiliser toutes les couleurs.<br />La couleur par défaut pour l’admin est <SPAN style=\"color:".COLOR_CA."\">".COLOR_CA."</SPAN>.<br />2. Les Moderateurs peuvent les utiliser toutes les couleurs sauf <SPAN style=\"color:".COLOR_CA."\">".COLOR_CA."</SPAN> et <SPAN style=\"color:".COLOR_CA1."\">".COLOR_CA1."</SPAN>.<br />La couleur par défaut des Moderateurs est <SPAN style=\"color:".COLOR_CM."\">".COLOR_CM."</SPAN>.<br />3. Les autres Utilisateurs peuvent utiliser toutes les couleurs sauf <SPAN style=\"color:".COLOR_CA."\">".COLOR_CA."</SPAN>, <SPAN style=\"color:".COLOR_CA1."\">".COLOR_CA1."</SPAN>, <SPAN style=\"color:".COLOR_CM."\">".COLOR_CM."</SPAN> et <SPAN style=\"color:".COLOR_CM1."\">".COLOR_CM1."</SPAN>.");
define("L_COL_HELP_P3a", "La couleur par défaut est <u><SPAN style=\"color:".COLOR_CD."\">".COLOR_CD."</SPAN></u>.<br /><br /><u>Conseil technique</u>: Ces couleurs sont definis par l’administrateur dans le paneau d’administration .<br />Si qqch ne fonctionne pas correctement, ou si il y a qqch que vous n’aimez pas, a propos de la couleur par défaut, contactez l’<b>administrateur</b> en premier, et pas les autres utilisateur du salon. :-)");
