<?php
// File : italian/localized.chat.php - plus version (20.07.2007 - rev.24)
...
<li>Tieni al minimo l’uso del MAIUSCOLO, è considerato un giallo.</li>
...
define("L_COL_HELP_P3a", "Il colore di default è <u><SPAN style=\"color:".COLOR_CD."\">".COLOR_CD."</SPAN></u>.<br /><br /><u>Materiale tecnico</u>: Questi colori sono definiti dall’amministratore nel pannello di controllo.<br />Se qualcosa va storto o se c’è qualcosa che non ti piace per i colori di default, devi contattare prima l’<b>amministratore</b>, non gli altri utenti nlla tua stanza. :-)");
...
define("L_PASS_11", "Bentornato nella nostra chat server!");
