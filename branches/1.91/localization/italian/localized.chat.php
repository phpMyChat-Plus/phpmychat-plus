<?php
// File : italian/localized.chat.php - plus version (14.04.2007 - rev.17)
...
define("L_REG_17", "Il tuo profilo è stato è stato cambiato.");
...
define("L_HELP_ETIQ_2", "Il nostro sito piacerebbe tenere la sua comunità amichevole e simpatica, quindi la preghiamo di aderire le seguenti direttive. Se manchi l`osservazione di queste regole, un moderatore della nostra chat potrebbe espellerti dalla chat.<br /><br>Grazie!");
define("L_HELP_ETIQ_3", "Direttive della nostra chat");
define("L_HELP_ETIQ_4", "No &quot;spam&quot; nella chat digitando senza senso o lettere a caso.</li><li>Non usare caratteri AltErNati </li><li>Tieni al minimo l`uso del MAIUSCOLO, è considerato un giallo</li><li>Tine nella mente che gli utenti della nostra chat sono di tutto il mondo, e, la maggior parte, incontrrearnno gente di diversa fede. Per piacere sii gentile e rispettoso per questa gente.</li><li>Nom essere maleducato verso gli altri membri. In effetti, prova a stare completamente alla larga dalle profane e/o parolacce </li><li>Non chiamare i membri con il loro nome reale che potrebbe non essere apprezzato. Usa il loro nickname.");
...
define("L_AWAY", "%s è in away");
define("L_BACK", "%s è tornato!");
...
define("L_PRO_6", "Colore testo del tuo nome");
...
define("BOT_PRIVONLY_TIPS", "TIPS: Il nostro bot è pubblicamente attivo. Puoi solo parlare in privato cliccando sul suo nome. (comando: /a <b>".C_BOT_NAME."</b> Messaggio o /wisp <b>".C_BOT_NAME."</b> Messaggio)"); //make sure your translation don't go too long here; it must fit to one line on the banner (under topic)
...
define("L_PRIV_POPUP", "Puoi disabilitare /riabilitare sempre questo servizio popup <br>variando il tuo profilo (solo utenti registrati)");
...
define("L_COLOR_HEAD_SETTINGSa", "<u>Colori di default</u>: Amministratore = <b><SPAN style=\"colore:".COLOR_CA."\">".COLOR_CA."</SPAN></b>, Moderatori = <b><SPAN style=\"colore:".COLOR_CM."\">".COLOR_CM."</SPAN></b>, Altri utenti = <b><SPAN style=\"colore:".COLOR_CD."\">".COLOR_CD."</SPAN></b>.");
define("L_COLOR_HEAD_SETTINGSb", "<u>Colori di default</u>: <b><SPAN style=\"colore:".COLOR_CD."\">".COLOR_CD."</SPAN></b>.");
define("L_COL_HELP_TITLE", "Colore raccoglitore");
define("L_COL_HELP_SUB1", "Uso:");
define("L_COL_HELP_P1", "Puoi selezionare il tuo colore modificando il tuo profilo (lo stesso colore come il tuo username). Sarai ancora abilitato ad usare qualsiasi altro colore.Per reimpostare il tuo colore di default da uno usato casualmente, devi scegliere uno dei colori di default (Null) - è il primo nella lista dis elezione.");
...
define("L_COL_HELP_P3", "<u>Livelli per l`uso di colori</u>:<br>1. Amministratore può usare qualsiasi colore.<br>Il colore di default per amministratore è <SPAN style=\"colore:".COLOR_CA."\">".COLOR_CA."</SPAN>.<br>2. Moderatori possono usare qualsiasi colore ma <SPAN style=\"colore:".COLOR_CA."\">".COLOR_CA."</SPAN> e <SPAN style=\"colore:".COLOR_CA1."\">".COLOR_CA1."</SPAN>.<br>Il colore di default dei moderatori è <SPAN style=\"colore:".COLOR_CM."\">".COLOR_CM."</SPAN>.<br>3. Gli altri utenti possono usare qualsiasi colore ma <SPAN style=\"colore:".COLOR_CA."\">".COLOR_CA."</SPAN>, <SPAN style=\"colore:".COLOR_CA1."\">".COLOR_CA1."</SPAN>, <SPAN style=\"colore:".COLOR_CM."\">".COLOR_CM."</SPAN> e <SPAN style=\"colore:".COLOR_CM1."\">".COLOR_CM1."</SPAN>.");
define("L_COL_HELP_P3a", "Il colore di default è <u><SPAN style=\"colore:".COLOR_CD."\">".COLOR_CD."</SPAN></u>.<br /><br /><u>Materiale tecnico</u>: Questi colori sono definiti dall`amministratore nel pannello di controllo.<br>Se qualcosa va storto o se c`è qualcosa che non ti piace per i colori di default, devi contattare prima l`<b>amministratore</b>, non gli altri utenti nlla tua stanza. :-)");
