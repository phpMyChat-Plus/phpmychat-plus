<?php
// File : italian/localized.tutorial.php - plus version (10.07.2007 - rev.6)
...
<TR>
	<TD ALIGN="center"><FONT SIZE="+2" COLOR="GREEN"><B>- Guida in italiano per <?php echo(APP_NAME." - ".APP_VERSION.APP_MINOR); ?> -</FONT><br /><I>Traduzione di <a href="mailto:rinodeniro@hotmail.com?subject=Italian%20phpMyChat%20Plus%20translation" onMouseOver="window.status='Clicca per una mail all’autore.'; return true;" title="Clicca per una mail all’autore" target=_blank>Michele Ferro</a> - Foggia, Italia - &copy; 2007<?php echo((date(Y)>"2007") ? "-".date(Y) : ""); ?></I></B></TD>
</TR>
</TABLE><br /><br />
<P><A NAME="top"></P>
