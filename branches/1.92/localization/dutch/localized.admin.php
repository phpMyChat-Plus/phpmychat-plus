...
define("A_SHEET4_0", "je hebt de instellingen nog niet goed ingesteld in het <br />'chat/admin/mail4admin.php' script.");
...
define("A_SHEET5_0", "- Uw geinstaleerde phpMyChat-Plus versie is %s -\\nEr is een nieuwe versie te krijgen (%s)!");
define("A_SHEET5_1", "- Uw geinstaleerde phpMyChat-Plus versie is %s -<br>Er is een nieuwe versie te krijgen (%s)!<br>Als je de website wil bezoeken en de update's ophalen <br>Of wil kijken wat er nieuw is, klik dan op een van onderstaande links:");
?>