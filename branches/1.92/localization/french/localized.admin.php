...
define("A_SHEET4_0", "Vous n'avez pas défini les variables nécessaires dans le<br>'chat/admin/mail4admin.php' script.");
...
define("A_SHEET5_1", "- La version de phpMyChat-Plus installé est %s -<br>Il y a une nouvelle version de prete (%s)!<br>Si vous voulez visiter le site et obtenir la nouvelle version<br>ou voir ce qu'il y a de nouveau, utiliser le lien suivant:");
?>
