...
define("L_HELP_CMD_22", "Envia un sonido buzz y opcionalmente muestra un mensaje en la sala actual.<br />- Uso:<br />- uso previo: \"/buzz\" o \"/buzz mensaje que debe mostrarse\" - esto toca el sonido por defecto para buzz definido en el panel de Administracion;<br />- uso avanzado: \"/buzz ".L_HELP_BUZZ."\" o \"/buzz ".L_HELP_BUZZ." mensaje para mostrar\" - esto toca el archivo nombredelsonido.wav de la carpeta plus/sounds folder; por favor note el signo \"~\" que debe ser usado al principio de la segunda palabra, la cual es el nombre del archivo de sonido, sin la extensión .wav (sólo las extensiones .wav están permitidas).<br />Por defecto este es un comando del moderador/administrador.");
